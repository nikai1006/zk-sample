package net.nikai.zookeeper.sample.LeaderElection;
...
import net.nikai.zookeeper.sample.TestMainClient;
import net.nikai.zookeeper.sample.TestMainServer;

/**
 * @author <a href="nikai.net.cn">Nikai</a>
 * @version 2017年3月22日 下午10:33:34
 */
public class LeaderElection extends TestMainClient
{
	...
	void findLeader()
			throws InterruptedException, UnknownHostException, KeeperException
	{
		byte[] leader = null;
		try
		{
	...
	public static void main(String[] args)
	{
		...
		String connectString = "docker.nikai.net.cn:" + 2181;
		// TestMainServer.CLIENT_PORT;
